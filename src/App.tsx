...
function App() {
  ...
  return (
    <div className="App bg-gray-800 h-full">
      ...
      <section className="w-full bg-gray-900 p-4 flex justify-end items-center">
        <menu>
      ...
      <footer className='mt-8 px-4 py-8 bg-black text-white text-center'>
        <span className='flex justify-center items-center gap-1'>Desenvolvido por
          <a
